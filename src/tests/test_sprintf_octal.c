...
START_TEST(sprintf_9_octal) {
  char str1[BUFSIZ];
  char str2[BUFSIZ];
  char *str3 = "%o Test %3.o Test %5.7o TEST %9o";
  int val = 0;
  ck_assert_int_eq(sprintf(str1, str3, val, val, val, val),
                   s21_sprintf(str2, str3, val, val, val, val));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_10_octal) {
  char str1[BUFSIZ];
  char str2[BUFSIZ];
  char *str3 = "%o Test %3.o Test %5.7o TEST %9o %.o";
  int val = 32;
  int val2 = 8899;
  int val3 = 91918;
  int val4 = 32311;
