...
START_TEST(sprintf_3_string) {
  ...
  char str2[BUFSIZ];
  char *str3 = "%s water %s water %s";
  char *val = "Don't need this water";
...
START_TEST(sprintf_5_string) {
  char str1[BUFSIZ];
  char str2[BUFSIZ];
  char *str3 = "%3s water %5s water %10s";
...
START_TEST(sprintf_6_string) {
  char str1[BUFSIZ];
  char str2[BUFSIZ];
  char *str3 = "%6.5s water %.23s water %3.s water %.s";
  char *val = "WHAT IS THIS";
...
START_TEST(sprintf_7_string) {
  char str1[BUFSIZ];
  char str2[BUFSIZ];
  char *str3 = "%-10.5s water %-.8s water %-7s water %-.s";
  char *val = "WHAT IS THIS";
  char *val2 = "i don't care anymore, really";
  char *val3 = "PPAP";
  char *val4 = "I don't feel so good";
...
START_TEST(sprintf_8_string) {
  char str1[BUFSIZ];
  char str2[BUFSIZ];
  char *str3 = "%0s water %0.s water %0.0s water %0s %.s";
  char *val = "WHAT IS THIS";
  char *val2 = "i don't care anymore, really";
  char *val3 = "PPAP";
  char *val4 = "I don't feel so good";
...
START_TEST(sprintf_9_string) {
  char str1[BUFSIZ];
  char str2[BUFSIZ];
  char *str3 = "%+s water %+3.s water %5.7s water %10s";
  char *val = "WHAT IS THIS";
  char *val2 = "i don't care anymore, really";
  char *val3 = "abcd";
  char *val4 = "I don't feel so good";
...
START_TEST(sprintf_11_string) {
  char str1[BUFSIZ];
  char str2[BUFSIZ];
  char *str3 = "% s water % 3.s water % 5.7s water % 10s GOD %.s";
  char *val = "WHAT IS THIS";
  char *val2 = "i don't care anymore, really";
  char *val3 = "PPAP";
  char *val4 = "I don't feel so good";
...
START_TEST(sprintf_12_string) {
  char str1[BUFSIZ];
  char str2[BUFSIZ];
  char *str3 = "%+s water %+3.s water %+5.7s water %+10s %+.s";
  char *val = "WHAT IS THIS";
  char *val2 = "i don't care anymore, really";
  char *val3 = "PPAP";
  char *val4 = "I don't feel so good";
...
START_TEST(sprintf_13_string) {
  char str1[BUFSIZ];
  char str2[BUFSIZ];
  char *str3 = "%#s water %#3s water %#5.7s water %#.7s Oof %#.s";
  char *val = "WHAT IS THIS";
  char *val2 = "i don't care anymore, really";
  char *val3 = "PPAP";
  char *val4 = "I don't feel so good";
...
START_TEST(sprintf_14_string) {
  char str1[BUFSIZ];
  char str2[BUFSIZ];
  char *str3 = "%0s water %6s water %5.7s water %0.7s Oof %0.s";
  char *val = "WHAT IS THIS";
  char *val2 = "idx";
  char *val3 = "PPAP";
  char *val4 = "I don't";
...
START_TEST(sprintf_15_string) {
  char str1[BUFSIZ];
  char str2[BUFSIZ];
  char *str3 = "%*s water %-*s water %*.*s water %.*s";
  char *val = "WHAT IS THIS";
  char *val2 = "i don't care anymore, really";
  char *val3 = "PPAP";
  char *val4 = "I don't feel so good";
