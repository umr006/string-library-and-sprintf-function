...
START_TEST(sprintf_2_HEX) {
  ...
  int val1 = 0x7a4;
  int val2 = 0x3123;
  ck_assert_int_eq(sprintf(str1, str3, val1, val2),
                   s21_sprintf(str2, str3, val1, val2));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_10_HEX) {
  char str1[200];
  char str2[200];
  char *str3 = "%x Test %3.X Test %5.7X TEST %10X %X";
  int val = 0;
  ck_assert_int_eq(sprintf(str1, str3, val, val, val, val, val, val),
                   s21_sprintf(str2, str3, val, val, val, val, val));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_13_HEX) {
  char str1[200];
  char str2[200];
  char *str3 = "#X Test %#3x Test %#7X TEST %#7X Oof %#X";
  int val = 32;
  int val2 = 8899;
  int val3 = 91918;
  int val4 = 32311;
...
Suite *test_sprintf_HEX(void) {
  Suite *s = suite_create("suite_sprintf_H");
